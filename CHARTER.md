# Charter for the leopard-testbed Organization

This is the organizational charter for the leoscope-testbed GitHub Organization (the "Organization"). The Organization consists of the [Steering Committee](./STEERING-COMMITTEE.md), Community leaders (see [code of conduct](./CODE-OF-CONDUCT.md)), and project-wise Maintainers and Contributors. By adding their name to the [Steering Committee.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.

## 1. Mission

The mission of this Organization is to maintain and upgrade/improve the LEOScope testbed code.
